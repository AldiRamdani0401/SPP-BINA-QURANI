<aside id="sidebar" class="bg-[#5D8736] w-[20%] border-r-[1px] border-lime-300 shadow-2xl">
  <ul class="py-2 h-full overflow-auto no-scrollbar">
    <!-- Dashboard -->
    <li class="px-2 py-1 bg-lime-700 text-white hover:font-semibold hover:bg-lime-600 cursor-pointer">
    ...
    <!-- === Master Data === -->
    <li class="mt-2 bg-lime-700 text-white hover:font-semibold hover:bg-lime-600 cursor-pointer">
      <button id="masterdata" class="group flex flex-row justify-between  gap-2 w-full">
        ...
        <span id="btn-drop-icon-masterdata" class="px-2 py-1 text-lg bg-lime-800 group-hover:bg-lime-700">+</span>
      </button>
    </li>
    <!-- ** Dropdown Master Data ** -->
    <div id="dropdown-masterdata" class="hidden">
      <ul class="bg-lime-800">
        <li>
          <a href="/admin/master-data/siswa"
            class="flex flex-row items-center gap-2 py-2 pl-5 text-left text-white border-t-[1px] border-lime-600 w-full hover:bg-lime-500 hover:font-semibold">
            <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
              <path
    ...
    <li class="mt-2 bg-lime-700 text-white hover:font-semibold hover:bg-lime-600 cursor-pointer">
      <button id="pembayaran-spp" class="group flex flex-row justify-between  gap-2 w-full">
        ...
        <span id="btn-drop-icon-pembayaran-spp" class="px-2 py-1 text-lg bg-lime-800 group-hover:bg-lime-700">+</span>
      </button>
    </li>
    ...
    <li class="mt-2 bg-lime-700 text-white hover:font-semibold hover:bg-lime-600 cursor-pointer">
      <button id="pengaturan-spp" class="group flex flex-row justify-between  gap-2 w-full">
        ...
        <span id="btn-drop-icon-pengaturan-spp" class="px-2 py-1 text-lg bg-lime-800 group-hover:bg-lime-700">+</span>
      </button>
    </li>
    ...
    <li class="mt-2 bg-lime-700 text-white hover:font-semibold hover:bg-lime-600 cursor-pointer">
      <button id="manajemen-akun" class="group flex flex-row justify-between  gap-2 w-full">
        ...
        <span id="btn-drop-icon-manajemen-akun" class="px-2 py-1 text-lg bg-lime-800 group-hover:bg-lime-700">+</span>
      </button>
    </li>
    ...
    <li class="mt-2 bg-lime-700 text-white hover:font-semibold hover:bg-lime-600 cursor-pointer">
      <button id="laporan-statistik" class="group flex flex-row justify-between  gap-2 w-full">
        ...
        <span id="btn-drop-icon-laporan-statistik"
          class="px-2 py-1 text-lg bg-lime-800 group-hover:bg-lime-700">+</span>
      </button>
    </li>
    ...
    <!-- === Pengaturan Aplikasi === -->
    <li class="mt-2 bg-lime-700 text-white hover:bg-lime-600 cursor-pointer">
