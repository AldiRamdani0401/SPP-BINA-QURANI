<aside id="sidebar" class="bg-slate-300 w-[20%] shadow-4xl">
  <div class="flex flex-col justify-between h-full overflow-auto no-scrollbar">
    <ul class="flex flex-col py-2 h-full overflow-auto no-scrollbar">
      <!-- Dashboard -->
      <li class="px-2 py-1 bg-slate-600 text-slate-200 hover:text-slate-700 hover:font-semibold hover:bg-slate-200 cursor-pointer">
        <a href="/admin" class="flex flex-row items-center gap-2">
      ...
      <!-- === Master Data === -->
      <li class="mt-2 bg-slate-600 text-slate-200 hover:text-slate-700 hover:font-semibold  hover:bg-slate-200 cursor-pointer">
        <button id="masterdata" class="group flex flex-row justify-between  gap-2 w-full">
          <div class="flex flex-row items-center px-2 py-1 gap-2">
            <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
              <path
          ...
          <span id="btn-drop-icon-masterdata" class="px-2 py-1 text-lg bg-slate-800 text-white">+</span>
        </button>
      </li>
      <!-- ** Dropdown Master Data ** -->
      <div id="dropdown-masterdata" class="hidden">
        <ul class="bg-slate-500">
          <li>
            <a href="/admin/master-data/siswa"
          ...
          <li>
            <a href="/admin/master-data/orang-tua-siswa"
              class="flex flex-row items-center gap-2 py-2 pl-5 text-left text-white border-t-[1px] border-[#03130741] w-full hover:text-slate-800 hover:bg-slate-200 hover:font-semibold">
              <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
      ...
      <!-- === Pembayaran SPP === -->
      <li class="mt-2 bg-slate-600 text-slate-200 hover:text-slate-700 hover:font-semibold  hover:bg-slate-200 cursor-pointer">
        <button id="pembayaran-spp" class="group flex flex-row justify-between  gap-2 w-full">
          <div class="flex flex-row items-center px-2 py-1 gap-2">
          <svg
            width="1em"
            height="1em"
          ...
          <span id="btn-drop-icon-pembayaran-spp" class="px-2 py-1 text-lg bg-slate-800 text-white">+</span>
        </button>
      </li>
      <!-- ** Dropdown Pembayaran SPP ** -->
      ...
      <!-- === Pengaturan SPP === -->
      <li class="mt-2 bg-slate-600 text-slate-200 hover:text-slate-700 hover:font-semibold  hover:bg-slate-200 cursor-pointer">
        <button id="pengaturan-spp" class="group flex flex-row justify-between  gap-2 w-full">
          <div class="flex flex-row items-center px-2 py-1 gap-2">
            <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
              <path
                d="M3.904 1.777C4.978 1.289 6.427 1 8 1s3.022.289 4.096.777C13.125 2.245 14 2.993 14 4s-.875 1.755-1.904 2.223C11.022 6.711 9.573 7 8 7s-3.022-.289-4.096-.777C2.875 5.755 2 5.007 2 4s.875-1.755 1.904-2.223" />
          ...
          <span id="btn-drop-icon-pengaturan-spp" class="px-2 py-1 text-lg bg-slate-800 text-white">+</span>
        </button>
      </li>
        ...
        <ul class="bg-slate-500">
          ...
          <li>
            <button
              ...
              <span>Status SPP</span></button>
          </li>
        </ul>
      </div>
      <!-- === Manajemen Akun === -->
      <li class="mt-2 bg-slate-600 text-slate-200 hover:text-slate-700 hover:font-semibold  hover:bg-slate-200 cursor-pointer">
        <button id="manajemen-akun" class="group flex flex-row justify-between  gap-2 w-full">
          <div class="flex flex-row items-center px-2 py-1 gap-2">
            <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
              <path
                d="M3.904 1.777C4.978 1.289 6.427 1 8 1s3.022.289 4.096.777C13.125 2.245 14 2.993 14 4s-.875 1.755-1.904 2.223C11.022 6.711 9.573 7 8 7s-3.022-.289-4.096-.777C2.875 5.755 2 5.007 2 4s.875-1.755 1.904-2.223" />
          ...
          <span id="btn-drop-icon-manajemen-akun" class="px-2 py-1 text-lg bg-slate-800 text-white">+</span>
        </button>
      </li>
      <!-- ** Dropdown Manajemen Akun ** -->
      <div id="dropdown-manajemen-akun" class="hidden">
        <ul class="bg-slate-500">
          <li>
            <button
              class="flex flex-row items-center gap-2 py-2 pl-5 text-left text-white border-t-[1px] border-[#03130741] w-full hover:text-slate-800 hover:bg-slate-200 hover:font-semibold">
      ...
      <!-- === Laporan & Statistik === -->
      <li class="mt-2 bg-slate-600 text-slate-200 hover:text-slate-700 hover:font-semibold  hover:bg-slate-200 cursor-pointer">
        <button id="laporan-statistik" class="group flex flex-row justify-between  gap-2 w-full">
          <div class="flex flex-row items-center px-2 py-1 gap-2">
            <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
              <path
                d="M3.904 1.777C4.978 1.289 6.427 1 8 1s3.022.289 4.096.777C13.125 2.245 14 2.993 14 4s-.875 1.755-1.904 2.223C11.022 6.711 9.573 7 8 7s-3.022-.289-4.096-.777C2.875 5.755 2 5.007 2 4s.875-1.755 1.904-2.223" />
          ...
          <span id="btn-drop-icon-laporan-statistik"
            class="px-2 py-1 text-lg bg-slate-800 text-white">+</span>
        </button>
      </li>
      <!-- ** Dropdown Laporan & Statistik ** -->
      <div id="dropdown-laporan-statistik" class="hidden">
        <ul class="bg-slate-500">
          <li>
            <button
              class="flex flex-row items-center gap-2 py-2 pl-5 text-left text-white border-t-[1px] border-[#03130741] w-full hover:text-slate-800 hover:bg-slate-200 hover:font-semibold">
      ...
      <!-- === Pengaturan Aplikasi === -->
      <li class="mt-2 bg-slate-600 text-slate-200 hover:text-slate-700 hover:font-semibold  hover:bg-slate-200 cursor-pointer">
        <button id="pengaturan-aplikasi" class="group flex flex-row justify-between  gap-2 w-full">
          <div class="flex flex-row items-center px-2 py-1 gap-2">
            <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
              <path
                d="M3.904 1.777C4.978 1.289 6.427 1 8 1s3.022.289 4.096.777C13.125 2.245 14 2.993 14 4s-.875 1.755-1.904 2.223C11.022 6.711 9.573 7 8 7s-3.022-.289-4.096-.777C2.875 5.755 2 5.007 2 4s.875-1.755 1.904-2.223" />
          ...
          <span id="btn-drop-icon-pengaturan-aplikasi"
            class="px-2 py-1 text-lg bg-slate-800 text-white">+</span>
        </button>
      </li>
      <!-- ** Dropdown Pengaturan Aplikasi ** -->
      <div id="dropdown-pengaturan-aplikasi" class="hidden">
        <ul class="bg-slate-500">
          <li>
            <button
              class="flex flex-row items-center gap-2 py-2 pl-5 text-left text-white border-t-[1px] border-[#03130741] w-full hover:text-slate-800 hover:bg-slate-200 hover:font-semibold">
              ...
              </svg><span>Notifikasi</span></button>
          </li>
        </ul>
      </div>
    </ul>
    <!-- footer -->
    <div class="bg-gray-800 text-white text-center py-1 text-sm">
      &copy Copyright - 2025 | Bina Qur'ani Karawang
    </div>
  </ul>
</aside>
<script>
  window.addEventListener("DOMContentLoaded", () => {
    ...
    const sidebarButtons = Array.from(sidebarElement.getElementsByTagName('button'));
    sidebarButtons.map((button, index) => {
      button.addEventListener("click", () => {
        const dropdown = sidebarElement.querySelector(`#dropdown-${button.id}`);
        const btnDropIcon = sidebarElement.querySelector(`#btn-drop-icon-${button.id}`);
        if (dropdown.className === 'hidden') {
          dropdown.classList.remove('hidden');
          btnDropIcon.classList.remove("px-2");
          btnDropIcon.classList.add("px-[10.5px]");
          btnDropIcon.innerHTML = "-";
        } else {
          dropdown.classList.add('hidden');
          btnDropIcon.classList.remove("px-[10.5px]");
          btnDropIcon.classList.add("px-2");
          btnDropIcon.innerHTML = "+";
        }
      });
    });
