...
<div class="flex flex-col w-[80%] bg-slate-50">
  ...
  <div class="flex flex-col justify-center w-full shadow-xl">
    <h1 class="text-xl px-3 py-1 font-bold bg-[#001A6E] text-white">Pembayaran SPP - Tunggakan</h1>
    <!-- Breadcrumb -->
    <h2 class="px-3 bg-slate-100 text-sm font-medium border">Pembayaran SPP / <span class="text-blue-600">Tunggakan</span></h2>
  </div>
  <!-- Container 2 : Table -->
