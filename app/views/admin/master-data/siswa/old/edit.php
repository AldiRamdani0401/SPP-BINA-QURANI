...
<script>
  ...
  function handleInputNIK(e) {
    ...
    editTimer = setTimeout(() => {
      if (inputId == 'nik-ayah') {
        result = dt_ayah.find((data) => data.dt_ibu_kependudukan == value);
  ...
  // ** NIK Ayah : Input
  const editInputNikAyahElement = document.getElementById('nik-ayah');
  editInputNikAyahElement.addEventListener('keyup', (e) => handleInputNIK(e));
  // ** Nama Lengkap Ayah : Input
  const editInputNamaLengkapAyah = document.getElementById('nama-lengkap-ayah');
  ...
  // ** Email Ayah : Input
  const editInputEmailAyah = document.getElementById('email-ayah');
  ...
  const editInputNomorTeleponAyah = document.getElementById('nomor-telepon-ayah');
  ...
  // ** NIK Ibu : Input
  const editInputNikIbu = document.getElementById('nik-ibu');
  editInputNikIbu.addEventListener('keyup', (e) => handleInputNIK(e));
  // ** Nama Lengkap Ibu : Input
  const editInputNamaLengkapIbu = document.getElementById('nama-lengkap-ibu');
  ...
  // ** Email Ibu : Input
  const editInputEmailIbu = document.getElementById('email-ibu');
  ...
  const editInputNomorTeleponIbu = document.getElementById('nomor-telepon-ibu');
