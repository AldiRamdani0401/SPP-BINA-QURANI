...
<div class="flex flex-col gap-4 mt-5 py-2 px-4 bg-white w-fit  h-fit rounded-xl shadow-xl">
  <div class="">
  ...
  <form id="form-modal" method="POST" action="/master-data/siswa/create" enctype="multipart/form-data"
      ...
      <div class="group flex flex-col w-64 gap-2 border pt-2 pb-3 px-3 rounded-md shadow-lg">
        ...
        <div class="flex flex-col gap-1">
          ...
          <input type="text" id="rt" name="rt"
            class="px-2 border border-slate-300 rounded-md focus:ring focus:ring-1 focus:ring-blue-300"
            placeholder="Rukun Tetangga / RT" title="Hanya menerima angka 001 sampai 100"
            pattern="(0[0-9][1-9]|0[1-9][0-9]|100)" maxlength="3" required>
          <p id="error-message" class="text-red-500 text-sm hidden">RT harus berupa angka dalam rentang 001 hingga 100.</p>
        </div>
        ...
        <script>
          ...
          rtInput.addEventListener("input", () => {
            const value = rtInput.value;
            const isValid = /^0[0-9][1-9]$|^0[1-9][0-9]$|^100$/.test(value); // Pola valid
            if (!isValid) {
        ...
        <div class="flex flex-col gap-1">
          ...
          <input type="text" id="rw" inputmode="numeric" pattern="[0-9\s]{13,19}" name="rw"
            class="px-2 border border-slate-300 rounded-md focus:ring focus:ring-1 focus:ring-blue-300 "
        ...
        <div class="flex flex-col gap-1">
          ...
          <input type="text" id="kode-post" inputmode="numeric" pattern="[0-9\s]{13,19}" name="kode-post"
            class="px-2 border border-slate-300 rounded-md focus:ring focus:ring-1 focus:ring-blue-300 "
    ...
    <div class="flex flex-row gap-5 justify-between border">
      <button
        class="bg-red-600 hover:bg-red-400 hover:font-semibold text-white px-10 py-2 text-lg  rounded-md">Batal</button>
