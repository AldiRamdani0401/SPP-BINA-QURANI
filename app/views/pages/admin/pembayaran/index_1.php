<div id="content" class="container-lg relative flex flex-col h-full px-0 mx-auto bg-[#BBBBBB]">
  ...
  <div class="no-select flex flex-col px-5 py-4 items-center bg-[#769B27]">
    <h1 class="title-banner m-0 text-white text-2xl px-4 py-1">
      Master Data - Data Pembayaran SPP
    </h1>
  </div>
  <!-- Sub Content 1 -->
...
<script src="<?= base_url(path: 'assets/js/pembayaran/table.js') ?>"></script>
<script src="<?= base_url(path: 'assets/js/pembayaran/form/addForm.js') ?>"></script>